...
export const FEATURE_CATALOG: FeatureMeta[] = [
  ...
  { name: "competition_tier",   label: "Competition Tier",  desc: "Cached market-efficiency tier for the competition: 3 is most efficient, 1 is default or lower-confidence.", cat: "Market", fmt: "int" },
  { name: "hours_since_line_opened", label: "Hours Since Open", desc: "Hours since the sharp line first appeared in local odds history. Missing or future timestamps clamp to 0.", cat: "Movement", fmt: "float" },
  { name: "sharp_soft_spread",  label: "Sharp/Soft Spread", desc: "Difference between the soft book odds and the sharp-derived fair odds.", cat: "Value", fmt: "odds" },
  { name: "num_markets_same_event", label: "Event Market Count", desc: "Number of value markets currently detected on the same event, with a minimum of 1.", cat: "Market", fmt: "int" },
];
