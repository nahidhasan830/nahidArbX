...
Single source of truth for all agents working in this repository. Root `AGENTS.md` is the standard instruction entry point and symlinks to this file. `CLAUDE.md` exists only as a Claude Code compatibility symlink to `AGENTS.md`.
