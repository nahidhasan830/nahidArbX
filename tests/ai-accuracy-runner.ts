...
const SETTLEMENT_CASES: SettlementTestCase[] = [
  ...
  },
  {
    ...
    competition: "Ireland - Premier",
    startTime: "2026-05-15T18:45:00Z",
    groundTruth: { ftHome: 2, ftAway: 1 },
    settledBySource: "api-football",
  },
  {
    eventId: "4",
    homeTeam: "Panevezys",
    awayTeam: "Kauno Zalgiris",
    competition: "Lithuania - A Lyga",
    startTime: "2026-05-10T16:00:00Z",
    groundTruth: { ftHome: 1, ftAway: 1 },
    settledBySource: "api-football",
  },
  {
    eventId: "5",
  ...
  },
  {
    ...
    startTime: "2026-05-08T18:30:00Z",
    groundTruth: { ftHome: 3, ftAway: 2 },
    settledBySource: "espn",
  },
  {
    eventId: "7",
  ...
  },
  {
    ...
    startTime: "2026-05-03T16:30:00Z",
    groundTruth: { ftHome: 1, ftAway: 1 },
    settledBySource: "sofascore",
  },
  {
    ...
    startTime: "2026-05-03T18:30:00Z",
    groundTruth: { ftHome: 1, ftAway: 1 },
    settledBySource: "sofascore",
  },
  {
    ...
    startTime: "2026-05-02T11:30:00Z",
    groundTruth: { ftHome: 3, ftAway: 0 },
    settledBySource: "espn",
  },
  {
    eventId: "11",
    homeTeam: "Epitsentr Kamianets-Podilskyi",
    awayTeam: "Polissya Zhytomyr",
    competition: "Ukraine - Premier League",
    startTime: "2026-05-12T12:30:00Z",
    groundTruth: { ftHome: 3, ftAway: 2 },
    settledBySource: "api-football",
  },
  {
    ...
    competition: "Argentina - Liga Pro",
    startTime: "2026-05-13T21:45:00Z",
    groundTruth: { ftHome: 1, ftAway: 1 },
    settledBySource: "sofascore",
  },
  {
    eventId: "13",
    homeTeam: "Academia Puerto Cabello",
    awayTeam: "Deportivo La Guaira",
    competition: "Venezuela - Primera Division",
  ...
  },
  {
    ...
    awayTeam: "Jaguares de Cordoba",
    competition: "Colombia - Cup",
  ...
  },
  {
    ...
    awayTeam: "Atletico Bucaramanga",
    competition: "Colombia - Cup",
    startTime: "2026-05-11T23:00:00Z",
    groundTruth: { ftHome: 2, ftAway: 0 },
    settledBySource: "api-football",
  },
  {
    eventId: "16",
    homeTeam: "Pharco FC",
    awayTeam: "Modern Sport",
    competition: "Egypt - Premier League",
    startTime: "2026-05-12T14:00:00Z",
    groundTruth: { ftHome: 0, ftAway: 1 },
    settledBySource: "api-football",
  },
  {
    eventId: "17",
    ...
    startTime: "2026-05-13T22:30:00Z",
    groundTruth: { ftHome: 0, ftAway: 2 },
    settledBySource: "api-football",
  },
  {
    eventId: "18",
    homeTeam: "Hassania Agadir",
    awayTeam: "Olympic Safi",
  ...
  {
    eventId: "19",
    homeTeam: "Santiago Wanderers",
    awayTeam: "Deportes Temuco",
    competition: "Chile - Primera B",
    startTime: "2026-05-03T19:00:00Z",
    groundTruth: { ftHome: 2, ftAway: 2 },
    settledBySource: "sofascore",
  },
  {
    eventId: "20",
    homeTeam: "Pardubice",
    awayTeam: "MFK Karvina",
    competition: "Czech Republic - First Liga",
    startTime: "2026-05-10T13:00:00Z",
    groundTruth: { ftHome: 1, ftAway: 3 },
    settledBySource: "ai-search-hf",
  },
];
...
async function runSettlementTests(
  ...
  for (let i = 0; i < cases.length; i++) {
    ...
    try {
      ...
      console.log(
        `${icon} AI:${aiScore} GT:${tc.groundTruth.ftHome}-${tc.groundTruth.ftAway} conf:${verdict.confidence}%`,
      );
  ...
  const highConfCorrect = results.filter(
    (r) => r.aiConfidence >= 70 && r.scoreCorrect,
  ).length;
  const highConfTotal = results.filter((r) => r.aiConfidence >= 70).length;
  const highConfAcc =
    highConfTotal > 0
      ? ((highConfCorrect / highConfTotal) * 100).toFixed(1)
      : "N/A";
